DROP DATABASE IF EXISTS ekahc294_ekah;
CREATE DATABASE ekahc294_ekah;
USE ekahc294_ekah;
...
FOREIGN KEY (id_etat_activite) REFERENCES etat_activite(id)
);
...
INSERT INTO etat_activite(id, nom) VALUES (1, "Activer");
INSERT INTO etat_activite(id, nom) VALUES (2, "Desactiver");


INSERT INTO activite(id, id_type_activite,id_etat_activite, nom, description_breve, description_longue, cout) VALUES (1, 2, 1, "Soins à domicile", "Pour apprendre à se détendre, respirer, prendre soin de soi, écouter son corps, guérir ses blessures et améliorer sa posture, nous offrons des services à domicile en kinésiologie-kinésithérapie, ostéopathie, orthothérapie massothérapie et aromathérapie.", "LONGUE", 100);
...
INSERT INTO activite(id, id_type_activite,id_etat_activite, nom, description_breve, description_longue) VALUES (9, 1, 1, "Cérémonies privées", "Pour vivre une expérience sur mesure; cérémonie de cacao, danse extatique, soirée de yoga et de méditation et toute autre co-création de votre imagination, nous offrons des ateliers sur mesure avec une durée et un contenu pré-déterminé.", "LONGUE");
...
INSERT INTO utilisateur(id_type_utilisateur, id_type_etat_dispo, fk_id_adresse, nom, prenom, date_inscription, photo) VALUES (2, 1, 1, "Philion Couet", "Gabriel", NOW(), "img1.jpg");
INSERT INTO utilisateur(id_type_utilisateur, id_type_etat_dispo, fk_id_adresse, nom, prenom, date_inscription, photo) VALUES (2, 1, 2, "Morin", "Raphaël", NOW(), "img2.jpg");
INSERT INTO utilisateur(id_type_utilisateur, id_type_etat_dispo, fk_id_adresse, nom, prenom, date_inscription, photo) VALUES (2, 1, 3, "Laberge", "Claudie", NOW(), "img3.jpg");
INSERT INTO utilisateur(id_type_utilisateur, id_type_etat_dispo, fk_id_adresse, nom, prenom, date_inscription, date_naissance) VALUES (1, null, 4, "Desmarais", "Annie", NOW(), "1995-09-01");
INSERT INTO utilisateur(id_type_utilisateur, id_type_etat_dispo, fk_id_adresse, nom, prenom, date_inscription) VALUES (1, null, 1, "Nault", "Beatrice", NOW());
INSERT INTO utilisateur(id_type_utilisateur, id_type_etat_dispo, fk_id_adresse, nom, prenom, date_inscription) VALUES (1, null, 2, "Bourgeois", "Charlotte", NOW());
INSERT INTO utilisateur(id_type_utilisateur, id_type_etat_dispo, fk_id_adresse, nom, prenom, date_inscription) VALUES (1, null, 3, "Lafrance", "David", NOW());
INSERT INTO utilisateur(id_type_utilisateur, id_type_etat_dispo, fk_id_adresse, nom, prenom, date_inscription, date_naissance) VALUES (1, null, 5, "Castonguay", "Jade", NOW(), "1988-01-08");
INSERT INTO utilisateur(id_type_utilisateur, id_type_etat_dispo, fk_id_adresse, nom, prenom, date_inscription, date_naissance) VALUES (1, null, 6, "Pellerin", "Audrey", NOW(), "1989-06-17");
INSERT INTO utilisateur(id_type_utilisateur, id_type_etat_dispo, fk_id_adresse, nom, prenom, date_inscription, date_naissance) VALUES (1, null, 7, "Leroux", "Mathieu", NOW(), "1964-12-04");
INSERT INTO utilisateur(id_type_utilisateur, id_type_etat_dispo, fk_id_adresse, nom, prenom, date_inscription, date_naissance) VALUES (1, null, 8, "Larochelle", "Camille", NOW(), "1979-09-02");
INSERT INTO utilisateur(id_type_utilisateur, id_type_etat_dispo, fk_id_adresse, nom, prenom, date_inscription, date_naissance) VALUES (1, null, 9, "Brousseau", "Rosalie", NOW(), "1981-05-19");
INSERT INTO utilisateur(id_type_utilisateur, id_type_etat_dispo, fk_id_adresse, nom, prenom, date_inscription, date_naissance) VALUES (1, null, 10, "Sauvé", "Frank", NOW(), "1971-11-09");
INSERT INTO utilisateur(id_type_utilisateur, id_type_etat_dispo, fk_id_adresse, nom, prenom, date_inscription, date_naissance) VALUES (1, null, 11, "Laurin", "Laura", NOW(), "1969-04-27");
INSERT INTO utilisateur(id_type_utilisateur, id_type_etat_dispo, fk_id_adresse, nom, prenom, date_inscription, date_naissance) VALUES (1, null, 12, "Lajeunesse", "Peach", NOW(), "1999-09-22");
INSERT INTO utilisateur(id_type_utilisateur, id_type_etat_dispo, fk_id_adresse, nom, prenom, date_inscription, date_naissance) VALUES (1, null, 13, "Fortin", "Antoine", NOW(), "1987-03-23");
INSERT INTO utilisateur(id_type_utilisateur, id_type_etat_dispo, fk_id_adresse, nom, prenom, date_inscription, date_naissance) VALUES (1, null, 14, "Tremblay", "Daisy", NOW(), "1956-07-29");
...
INSERT INTO inscription(id_utilisateur, id_groupe, date_inscription) VALUES (7, 13, '2020-04-03');
...
INSERT INTO reservation(id, id_paiement, id_emplacement, id_suivi, id_activite, id_groupe, id_facilitateur, date_rendez_vous, id_region, heure_fin, id_etat) VALUES (1, 1, 1, 1, 1, 1, 1, '2019-01-05 19:00', 1, '2019-01-05 19:30', 1);
INSERT INTO reservation(id, id_paiement, id_emplacement, id_suivi, id_activite, id_groupe, id_facilitateur, date_rendez_vous, id_region, heure_fin, id_etat) VALUES (2, 2, 2, 2, 1, 2, 2, '2019-02-02 13:00', 1, '2019-02-02 13:30', 1);
INSERT INTO reservation(id, id_paiement, id_emplacement, id_suivi, id_activite, id_groupe, id_facilitateur, date_rendez_vous, id_region, heure_fin, id_etat) VALUES (3, 3, 3, 3, 1, 3, 3, '2020-02-10 13:30', 1, '2020-02-10 14:30', 1);
INSERT INTO reservation(id, id_paiement, id_emplacement, id_suivi, id_activite, id_groupe, id_facilitateur, date_rendez_vous, id_region, heure_fin, id_etat) VALUES (4, 4, 4, 4, 2, 4, 1, '2020-02-24 07:00', 2, '2020-02-24 08:30', 1);
INSERT INTO reservation(id, id_paiement, id_emplacement, id_suivi, id_activite, id_groupe, id_facilitateur, date_rendez_vous, id_region, heure_fin, id_etat) VALUES (5, 5, 5, 5, 3, 5, 2, '2020-02-29 09:30', 3, '2020-02-29 10:30', 1);
INSERT INTO reservation(id, id_paiement, id_emplacement, id_suivi, id_activite, id_groupe, id_facilitateur, date_rendez_vous, id_region, heure_fin, id_etat) VALUES (6, 6, 6, 6, 1, 6, 1, '2020-03-01 19:30', 2, '2020-03-01 20:30', 1);
INSERT INTO reservation(id, id_paiement, id_emplacement, id_suivi, id_activite, id_groupe, id_facilitateur, date_rendez_vous, id_region, heure_fin, id_etat) VALUES (7, 7, 7, 7, 4, 7, 2, '2019-03-11 12:30', 3, '2019-03-11 13:00', 1);
INSERT INTO reservation(id, id_paiement, id_emplacement, id_suivi, id_activite, id_groupe, id_facilitateur, date_rendez_vous, id_region, heure_fin, id_etat) VALUES (8, 8, 8, 8, 1, 8, 3, '2020-03-15 09:30', 1, '2020-03-15 10:00', 1);
INSERT INTO reservation(id, id_paiement, id_emplacement, id_suivi, id_activite, id_groupe, id_facilitateur, date_rendez_vous, id_region, heure_fin, id_etat) VALUES (9, 9, 9, 9, 2, 9, 1, '2020-03-20 10:00', 1, '2020-03-20 10:30', 1);
INSERT INTO reservation(id, id_paiement, id_emplacement, id_suivi, id_activite, id_groupe, id_facilitateur, date_rendez_vous, id_region, heure_fin, id_etat) VALUES (10, 10, 10, 10, 3, 10, 2, '2020-03-24 11:30', 3, '2020-03-24 12:00', 1);
INSERT INTO reservation(id, id_paiement, id_emplacement, id_suivi, id_activite, id_groupe, id_facilitateur, date_rendez_vous, id_region, heure_fin, id_etat) VALUES (11, 11, 11, 11, 1, 11, 1, '2020-03-24 17:00', 2, '2020-03-24 17:30', 1);
INSERT INTO reservation(id, id_paiement, id_emplacement, id_suivi, id_activite, id_groupe, id_facilitateur, date_rendez_vous, id_region, heure_fin, id_etat) VALUES (12, 12, 12, 12, 5, 12, 2, '2019-04-02 13:30', 2, '2019-04-02 14:00', 1);
...
INSERT INTO activite_prix(activite_id, duree_id, facilitateur_id, prix) VALUES (1, 1, 1, 7000);
INSERT INTO activite_prix(activite_id, duree_id, facilitateur_id, prix) VALUES (1, 1, 2, 6500);
INSERT INTO activite_prix(activite_id, duree_id, facilitateur_id, prix) VALUES (1, 1, 3, 6000);
