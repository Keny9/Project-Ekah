...
//Test Utilisateur
$user = new Utilisateur(1, "Test", "Max", "2019-01-01", "Utilisateur@test.ca", "1996-09-01", 1231231234);
...
//Test Client
$client = new Client(2, "Test", "Client", "2019-01-03", "client@test.ca", "1996-09-01", 2341237869);
